...
rawAWD = circStudio.io.read_raw_awd(awd_path)


def test_instance_awd():

    assert isinstance(rawAWD, circStudio.io.awd.RawAWD)
...
def test_read_raw_aw4():
    ...
    rawAW4 = circStudio.io.read_raw_awd(aw4_path)
    assert (
...
def test_read_raw_aw4_engine():
    ...
    # read AW4 with default parameters
    rawAW4 = circStudio.io.read_raw_awd(aw4_path, engine='c')
    assert (
        (rawAW4.model == 'Actiwatch-4')
        & (rawAW4.frequency == pd.Timedelta('1min'))
        & (rawAW4.light is None)
...
def test_read_raw_aw7():
    ...
    rawAW7 = circStudio.io.read_raw_awd(aw7_path)
    assert (
...
def test_read_raw_awi():
    ...
    rawAWI = circStudio.io.read_raw_awd(awi_path)
    assert (
...
def test_read_raw_awl():
    ...
    rawAWL = circStudio.io.read_raw_awd(awl_path)
    assert (
...
def test_read_raw_awlp():
    ...
    rawAWLP = circStudio.io.read_raw_awd(awlp_path)
    assert (
...
def test_read_raw_awmk2():
    ...
    # read AW-Insomnia with default parameters
    rawAWMk2 = circStudio.io.read_raw_awd(awmk2_path)
    assert (
...
def test_read_raw_aws():
    ...
    # read AW-Insomnia with default parameters
    rawAWS = circStudio.io.read_raw_awd(aws_path)
    assert (
...
def test_read_raw_awt():
    ...
    # read AW-Insomnia with default parameters
    rawAWT = circStudio.io.read_raw_awd(awt_path)
    assert (
